...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Givecoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x2DE410D7, 0x1B8CF3F4, 0x277110A6, 0x19A46104B,
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Givecoin is probably already running."), addrBind.ToString().c_str());
        else
